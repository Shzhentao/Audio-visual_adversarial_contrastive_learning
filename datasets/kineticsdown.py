...
DATA_PATH = '/mnt/Zhentaob/datasets/kinetics-10K'  # DATA_PATH = '/mnt/Zhentaob/data/datasets/kinetics_small'

from datasets.video_db import VideoDataset


class Kineticsdown(VideoDataset):
    def __init__(self, subset,
        ...
        super(Kineticsdown, self).__init__(
            ...
            sample_grad_cam=sample_grad_cam,
